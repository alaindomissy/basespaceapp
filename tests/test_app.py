...
def test_parse_appsessionparams():
    ...
    expected = [{u'Content': u'False',
                  ...
                  {u'Content': u'25',
                   ...
                   u'Href': u'v1pre3/appsessions/31951397/properties/Input.binding_interference_gap',
                   u'Name': u'Input.binding_interference_gap',
                   u'Type': u'string'},
                  {u'Content': u'25',
                  ...
                  {u'Description': u'Restriction Enzymes',
                   u'Href': u'v1pre3/appsessions/31951397/properties/Input.restr_enzymes',
                   u'HrefItems': u'v1pre3/appsessions/31951397/properties/Input.restr_enzymes/items',
                   u'Items': [u'BfaI', u'ScrFI', u'HpaII'],
                   u'ItemsDisplayedCount': 3,
                   u'ItemsTotalCount': 3,
                   u'Name': u'Input.restr_enzymes',
                   u'Type': u'string[]'},
                  {u'Description': u'',
